...
import Me from '@/public/IMG-20240113.jpg'
  ...
  return (
    <section  
      ...
      <motion.h1 
        ...
        >
         <span className="font-bold">Hello, I'm Faiza.</span> I'm a{" "}
         <span className="font-bold">medical student</span> and{" "}
         <span className="font-bold">also </span>studying Gernative(AI). I enjoy
         bulding  <span className="italic">sites & apps</span>. My focus is{" "}
